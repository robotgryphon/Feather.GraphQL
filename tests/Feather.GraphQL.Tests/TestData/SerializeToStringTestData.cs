...
public class SerializeToStringTestData : IEnumerable<object[]>
{
    ...
    public IEnumerator<object[]> GetEnumerator()
    {
        ...
        yield return new object[]
        {
                ...
                new GraphQLRequest("simple query string", extensions: new Dictionary<string, object?>
                {
                        ["a"] = "abc",
                        ["b"] = true,
                        ["c"] = new Dictionary<string, object> { ["d"] = 42 }
                })
        };
        yield return new object[]
        {
                ...
                new GraphQLRequest("simple query string", new
                {
                        camelCaseProperty = "camelCase",
                        PascalCaseProperty = "PascalCase"
                })
        };
        yield return new object[]
        {
